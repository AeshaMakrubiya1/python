...
from pr7_kit_f import pr7_timebox as tmod, pr7_mathkit as mmod, pr7_rando as rmod, pr7_idgen as uidmod, pr7_fileops as fmod, pr7_explore as xmod
import math

def menu():
    print("\n========================")
    print("Welcome to Multi-Utility Toolkit (variant 6)")
    print("========================")
    ...
    while True:
        ...
        if c == "1":
            ...
            if ch == "1":
                ...
                import pr7_kit_f as P; print([m for m in dir(P) if m.startswith("pr7_")])
        elif c == "7":
            print("Goodbye!"); break
        else:
            print("Invalid.")
